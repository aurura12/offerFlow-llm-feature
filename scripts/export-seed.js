 ...
 *
 * 把本地 dev.db 里的 users/resumes/jobs/tasks/reviews 全量导出到
...
console.log(
  `  users: ${data.users.length}, resumes: ${data.resumes.length}, jobs: ${data.jobs.length}, tasks: ${data.tasks.length}, reviews: ${data.reviews.length}`
)
